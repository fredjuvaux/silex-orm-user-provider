...
class UserController
{
    ...
    protected $layoutTemplate = '@user/layout.twig.html';
    ...
    {
        return $app['twig']->render('@user/login.twig.html', array(
    ...
    public function registerAction(Application $app, Request $request)
    {
        ...
        return $app['twig']->render('@user/register.twig.html', array(
            'layout_template' => $this->layoutTemplate,
    ...
    public function viewAction(Application $app, Request $request, $id)
    {
        ...
        return $app['twig']->render('@user/view.twig.html', array(
            'layout_template' => $this->layoutTemplate,
            'user' => $user,
    ...
    public function editAction(Application $app, Request $request, $id)
    {
        ...
        return $app['twig']->render('@user/edit.twig.html', array(
            'layout_template' => $this->layoutTemplate,
            'error' => implode("\n", $errors),
            'user' => $user,
    ...
    public function listAction(Application $app, Request $request)
    {
        ...
        return $app['twig']->render('@user/list.twig.html', array(
            'layout_template' => $this->layoutTemplate,
            'users' => $users,
